...
namespace Get_Movies.Models
{
    public class Movie
    {
        ...
        public void Update(Movie newData, Boolean allRequired, Boolean exactStringMatching)
        {
            ...
            Boolean Updatable = this.Id.HasValue || this.Genre_Id.HasValue || !String.IsNullOrWhiteSpace(this.Director) || !String.IsNullOrWhiteSpace(this.Poster) || !String.IsNullOrWhiteSpace(this.Release_Date) || this.View_Count.HasValue || this.Rating_Count.HasValue;
