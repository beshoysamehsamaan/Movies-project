namespace Get_Movies.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Get_Movies.Data.GetMoviesContext>
    {
        ...
        protected override void Seed(GetMoviesContext context)
        {
            ...
            {
                Imdb_Id = "tt7694738",
                Title = "Best F(r)iends: Volume 2",
                Genre_Id = gen8.Id,
                Director = "Justin MacGregor",
                Poster = "http://image.tmdb.org/t/p/original//4YPkxyJJ5I6l88B5tpcxMRCNFA5.jpg",
                Release_Date = DateTime.ParseExact("01/06/2018", "dd/MM/yyyy", System.Globalization.CultureInfo.InvariantCulture),
                Release_Year = 2018,
                Description = "As Jon makes a run for it, he finds himself on an expedition across the Southwest, where he encounters wild and crazy characters through a series of twisted and dark foibles. While his ...",
                Duration = 120,
                Views_Count = 0
            };
            m5.Add();
            ...
            Movie m109 = new Movie()
            {
                ...
                Poster = "http://image.tmdb.org/t/p/original//8PUnfgnw615Ii8obYnIdGd4DINU.jpg",
                Release_Date = DateTime.ParseExact("16/07/2004", "dd/MM/yyyy", System.Globalization.CultureInfo.InvariantCulture),
                Release_Year = 2004,
                Description = "In 2035, technophobic homicide detective Del Spooner of the Chicago PD heads the investigation of the apparent suicide of leading robotics scientist, Dr. Alfred Lanning. Unconvinced of the motive, Spooner\'s investigation into Lanning\'s death reveals a trail of secrets and agendas within the USR (United States Robotics) corporation and suspicions of murder. Little does he know that his investigation would lead to uncovering a larger threat to humanity.",
                Duration = 115,
                Views_Count = 0
            };
            m109.Add();
            ...
            {
                Imdb_Id = "tt0110256",
                Title = "The Redemption: Kickboxer 5",
                Genre_Id = gen8.Id,
                Director = "Kristine Peterson",
                Poster = "http://image.tmdb.org/t/p/original//nleDZjAoAbuYqbnO9jIidON8Trh.jpg",
                Release_Date = DateTime.ParseExact("01/08/1995", "dd/MM/yyyy", System.Globalization.CultureInfo.InvariantCulture),
                Release_Year = 1995,
                Description = "Kickbox champion Matt Reeves witnesses the murder of his friend Johnny. When he investigates on the circumstances it appears that a Mr. Neegal in South Africa has founded a new kickbox association and does not leave international champions much of a chance. Johnny had to pay with his life when he did not want to join. Neegal seems to kill everybody who is in his way. Matt is on his own now, but suddenly finds an unexpected ally.",
                Duration = 87,
                Views_Count = 0
            };
            m202.Add();
            ...
            Movie m398 = new Movie()
            {
                ...
                Genre_Id = gen14.Id,
                Director = "Elia Kazan",
                Poster = "http://image.tmdb.org/t/p/original//eKFEJBmuArrsERARuJLYUD8ngAi.jpg",
