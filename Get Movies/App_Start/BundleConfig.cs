...
public class BundleConfig
{
    ...
    public static void RegisterBundles(BundleCollection bundles)
    {
        ...
        string propellerAccordionCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerAccordionCssDirectoryName);
        ...
        string propellerAlertCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerAlertCssDirectoryName);
        ...
        string propellerBadgeCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerBadgeCssDirectoryName);
        ...
        string propellerButtonCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerButtonCssDirectoryName);
        ...
        string propellerCardCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerCardCssDirectoryName);
        ...
        string propellerCheckboxCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerCheckboxCssDirectoryName);
        ...
        string propellerCustomScrollbarCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerCustomScrollbarCssDirectoryName);
        ...
        string propellerDataTableCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerDataTableCssDirectoryName);
        ...
        string propellerDateTimePickerCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerDateTimePickerCssDirectoryName);
        ...
        string propellerDropDownCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerDropDownCssDirectoryName);
        ...
        string propellerFileUploadCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerFileUploadCssDirectoryName);
        ...
        string propellerFloatingActionButtonCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerFloatingActionButtonCssDirectoryName);
        ...
        string propellerFormCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerFormCssDirectoryName);
        ...
        string propellerListCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerListCssDirectoryName);
        ...
        string propellerModalCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerModalCssDirectoryName);
        ...
        string propellerNavbarCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerNavbarCssDirectoryName);
        ...
        string propellerPaginationCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerPaginationCssDirectoryName);
        ...
        string propellerPopoverCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerPopoverCssDirectoryName);
        ...
        string propellerProgressbarCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerProgressbarCssDirectoryName);
        ...
        string propellerRadioCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerRadioCssDirectoryName);
        ...
        string propellerRangeSliderCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerRangeSliderCssDirectoryName);
        ...
        string propellerSelect2CssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerSelect2CssDirectoryName);
        ...
        string propellerTabCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerTabCssDirectoryName);
        ...
        string propellerTableCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerTableCssDirectoryName);
        ...
        string propellerTextfieldCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerTextfieldCssDirectoryName);
        ...
        string propellerToggleSwitchCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerToggleSwitchCssDirectoryName);
        ...
        string propellerTooltipCssBundleName = String.Concat(cssBundlesPrefix, propellerComponentsCssDirectoryName, "/", propellerTooltipCssDirectoryName);
        ...
        string propellerAccordionJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerAccordionJsDirectoryName);
        ...
        string propellerAlertJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerAlertJsDirectoryName);
        ...
        string propellerBadgeJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerBadgeJsDirectoryName);
        ...
        string propellerButtonJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerButtonJsDirectoryName);
        ...
        string propellerCardJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerCardJsDirectoryName);
        ...
        string propellerCheckboxJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerCheckboxJsDirectoryName);
        ...
        string propellerCustomScrollbarJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerCustomScrollbarJsDirectoryName);
        ...
        string propellerDataTableJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerDataTableJsDirectoryName);
        ...
        string propellerDateTimePickerJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerDateTimePickerJsDirectoryName);
        ...
        string propellerDropDownJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerDropDownJsDirectoryName);
        ...
        string propellerFileUploadJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerFileUploadJsDirectoryName);
        ...
        string propellerFloatingActionButtonJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerFloatingActionButtonJsDirectoryName);
        ...
        string propellerFormJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerFormJsDirectoryName);
        ...
        string propellerListJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerListJsDirectoryName);
        ...
        string propellerModalJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerModalJsDirectoryName);
        ...
        string propellerNavbarJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerNavbarJsDirectoryName);
        ...
        string propellerPaginationJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerPaginationJsDirectoryName);
        ...
        string propellerPopoverJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerPopoverJsDirectoryName);
        ...
        string propellerProgressbarJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerProgressbarJsDirectoryName);
        ...
        string propellerRadioJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerRadioJsDirectoryName);
        ...
        string propellerRangeSliderJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerRangeSliderJsDirectoryName);
        ...
        string propellerSelect2JsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerSelect2JsDirectoryName);
        ...
        string propellerTabJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerTabJsDirectoryName);
        ...
        string propellerTableJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerTableJsDirectoryName);
        ...
        string propellerTextfieldJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerTextfieldJsDirectoryName);
        ...
        string propellerToggleSwitchJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerToggleSwitchJsDirectoryName);
        ...
        string propellerTooltipJsBundleName = String.Concat(jsBundlesPrefix, propellerComponentsJsDirectoryName, "/", propellerTooltipJsDirectoryName);
